...
# Допуск сравнения чисел. LLM округляет значения до 2 знаков после запятой
# (например, 7.7086 -> 7.71), поэтому сравниваем с запасом 0.01: ошибка
# округления <= 0.005, а выдуманные числа отличаются на порядок сильнее.
