...
Этот документ фиксирует публичный интерфейс моей ML-части. Он нужен разработчику AI-агентов, чтобы подключить прогнозы, проверку аномалий и оптимизацию, не зная внутреннего устройства моделей.
